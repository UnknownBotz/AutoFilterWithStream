...
API_ID = int(environ['14350423'])
API_HASH = environ['838b0b81758d276215b3647821b707ad']
BOT_TOKEN = environ['6750893623:AAHY9w9sEtt9fXMMhK7Va7bWv_Z2ERKHOVs']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('6606973036', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1002141486939', '0').split()]
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://rgboy352:<maderchod yt>@cluster0.cehpl5x.mongodb.net/?retryWrites=true&w=majority', "")
DATABASE_NAME = environ.get('DATABASE_NAME', "godslayer")
...
LOG_CHANNEL = int(environ.get('-1001999208149', 0))
